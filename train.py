...
def parse_opt(known=False):
    ...
    parser.add_argument('--teacher_weight', type=str, default= 'yolov5x6.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco_3cls.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='y5x6_better_res', help='save to project/name')
